...
public class AlterRoupaIntima {
    ...
    public void roupasIntimas () throws SQLException {
        ...
        System.out.print("Informe o código da peça intima no qual gostaria de atualizar: ");
        int oldCod = sc.nextInt();

        String sql = "SELECT * FROM roupas_intimas WHERE codigo = ?";
        ...
        if (roupasIntimas.isEmpty()){
            ...
            for (RoupasIntimas r : roupasIntimas) {
                System.out.println("Gostaria de atualizar o registro da seguinte peça" +
                        " ==> " + r.getCodigo() + ", " + r.getMarca() + ", " + r.getModelo() + ", "
                        + r.getQuantidade());
            }
            ...
            while (continuar){
                ...
                if (condition.equalsIgnoreCase("S")) {
                    ...
                    if (desejo == 1) {
                        ...
                        System.out.println();
                        sql = "UPDATE roupas_intimas set MARCA = ? WHERE codigo = ?";
                        ...
                        System.out.println();
                        sql = "UPDATE roupas_intimas set TAMANHO = ? WHERE codigo = ?";
                        stmt = connection.prepareStatement(sql);
                        ...
                        System.out.println();
                        sql = "UPDATE roupas_intimas set COR = ? WHERE codigo = ?";
                        stmt = connection.prepareStatement(sql);
                        ...
                        System.out.println();
                        sql = "UPDATE roupas_intimas set MODELO = ? WHERE codigo = ?";
                        stmt = connection.prepareStatement(sql);
                        ...
                        System.out.println();
                        sql = "UPDATE roupas_intimas set QUANTIDADE = ? WHERE codigo = ?";
                        stmt = connection.prepareStatement(sql);
