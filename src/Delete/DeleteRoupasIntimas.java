...
public class DeleteRoupasIntimas {

    public void roupasIntimas () throws SQLException {
        Scanner sc = new Scanner(System.in);

        Connection connection = CreateConnection.getConnection();
        String select = "SELECT * FROM roupas_intimas WHERE codigo = ?";
        String delete = "DELETE FROM roupas_intimas WHERE codigo = ?";

        System.out.print("Informe o código da peça no qual gostaria de excluir: ");
        ...
        while (resultSet.next()){
            System.out.println("Deseja realmente excluir a seguinte peça intima ==> " +
