...
public class AlterCamisetas {
    ...
    public void camisas () throws SQLException {
        ...
        System.out.print("Informe o código da camiseta no qual gostaria de atualizar: ");
        int oldCod = sc.nextInt();

        String sql = "SELECT * FROM camisetas WHERE codigo = ?";
        ...
        if (camisetas.isEmpty()){
            ...
            for (Camiseta c : camisetas) {
                System.out.println("Gostaria de atualizar o registro da seguinte camiseta" +
            ...
            while (continuar) {
                if (condition.equalsIgnoreCase("S")) {
                    ...
                    if (desejo == 1) {
                        ...
                        System.out.println();
                        sql = "UPDATE camisetas set MARCA = ? WHERE codigo = ?";
                        ...
                        System.out.println();
                        sql = "UPDATE camisetas set TAMANHO = ? WHERE codigo = ?";
                        stmt = connection.prepareStatement(sql);
                        ...
                        System.out.println();
                        sql = "UPDATE camisetas set COR = ? WHERE codigo = ?";
                        stmt = connection.prepareStatement(sql);
                        ...
                        System.out.println();
                        sql = "UPDATE camisetas set MODELO = ? WHERE codigo = ?";
                        stmt = connection.prepareStatement(sql);
                        ...
                        sql = "UPDATE camisetas set QUANTIDADE = ? WHERE codigo = ?";
                        stmt = connection.prepareStatement(sql);
